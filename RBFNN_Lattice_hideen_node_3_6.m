...
% The controller law of adaptive feedforward RBFNN control with a lattice distribution of hidden nodes 
%is $\tau =  K_{2} e_2 +\hat{W}^T  S(Z_d)$. 
% $3^6$ hidden nodes are located at  $[-1,0,1]\times[-1,0,1]\times[-1,0,1]\times[-1,0,1]\times[-1,0,1]\times[-1,0,1]$. 
...
save("RBFNN_Lattice_hideen_node_3_6", 'q', 'e_q','Tau')
